...
class Webinar(models.Model):
    webinar_name = models.CharField('Заголовок H1', max_length=200)
    ...
    webinar_short_desc = models.TextField('Короткое описание для Schema', blank=True)
    webinar_image = models.ImageField('Изображение статьи')
    pub_date = models.DateTimeField(default=datetime.datetime.now)
