...
urlpatterns = [
    ...
    path('vnedrenie-paketnoe/', views.Vnedreniepaket.as_view(), name='vnedreniepaket'),
    path('vnedrenie-proektnoe/', views.Vnedrenieproektnoe.as_view(), name='Vnedrenieproektnoe'),
    ...
    path('vnedrenie-bi/', views.Bi.as_view(), name='bi'),
    path('obuchenie-bitrix/', views.Obuchenie.as_view(), name='obuchenie'),
    ...
    path('enterprise/', views.Enterprise.as_view(), name='enterprise'),
